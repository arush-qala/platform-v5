        ...
        <div ref={containerRef} className="relative min-h-[200vh] bg-white z-50">
            ...
            {prevProduct && (
                <div
                    ...
                    className="fixed left-0 top-0 h-screen w-24 hidden md:flex items-center justify-center cursor-pointer z-[55] group hover:bg-gray-50 transition-colors"
                >
                    <div className="opacity-30 group-hover:opacity-100 transition-opacity duration-300">
                        <ChevronLeft size={32} />
                    </div>
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 w-16 aspect-[2/3] opacity-0 group-hover:opacity-40 transition-opacity duration-300 pointer-events-none">
            ...
            {nextProduct && (
                <div
                    ...
                    className="fixed right-0 top-0 h-screen w-24 hidden md:flex items-center justify-center cursor-pointer z-[55] group hover:bg-gray-50 transition-colors"
                >
                    <div className="opacity-30 group-hover:opacity-100 transition-opacity duration-300">
                        <ChevronRight size={32} />
                    </div>
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 w-16 aspect-[2/3] opacity-0 group-hover:opacity-40 transition-opacity duration-300 pointer-events-none">
            ...
            {/* Main Content Area */}
            <div className="w-full max-w-[1600px] mx-auto flex pt-24 px-4 md:px-32 relative">
