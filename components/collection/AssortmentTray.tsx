            ...
            <AnimatePresence>
                {isTrayOpen && (
                    ...
                    >
                        ...
                        <button
                            onClick={onReview}
                            style={{ backgroundColor: '#000000', color: '#FFFFFF', minWidth: '140px' }}
                            className="flex-shrink-0 whitespace-nowrap px-6 py-2 text-xs uppercase tracking-widest hover:bg-gray-800 transition-colors rounded-full"
                        >
                            Review & Save
                        </button>
                    </motion.div>
