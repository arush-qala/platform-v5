                ...
                <div className="flex flex-col gap-y-24 w-full">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {['Ethical', 'Pure Cotton', 'Hand Dyeing', 'Sustainable'].map((tag, i) => (
                      <span key={i} className="px-14 py-5 rounded-full border border-black/5 text-xs uppercase tracking-[0.25em] text-black/60 hover:border-black hover:text-black transition-all duration-500 cursor-default bg-white hover:bg-black/5">
                        {tag}
                      </span>
                    ))}
                  </div>
