    ...
    return (
        <>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-full max-w-[90%] md:max-w-none flex justify-center pointer-events-none">
                <div className="bg-[#F5F3F0]/90 backdrop-blur-md px-7 py-3.5 rounded-lg shadow-sm flex flex-wrap items-center justify-center gap-x-1.5 gap-y-2 text-[16px] md:text-[17px] leading-relaxed pointer-events-auto transition-all duration-300 hover:bg-[#F5F3F0]/95">
                    ...
                    >
                        {category}
                        <ChevronDown size={12} className={`transition-transform duration-200 ${activeModal === 'category' ? 'rotate-180' : ''}`} />
                    </button>
                    ...
                    >
                        {season}
                        <ChevronDown size={12} className={`transition-transform duration-200 ${activeModal === 'season' ? 'rotate-180' : ''}`} />
                    </button>
                </div>
            </div>
