                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <div className="mb-8">
                                <h2 className="font-serif text-2xl mb-2">My Assortment</h2>
                            ...
                            {items.length === 0 ? (
                                <div className="text-center py-20 bg-gray-50 rounded-lg border border-dashed border-gray-200">
                                    ...
                                    <Link href="/collection/all">
                                        <button className="px-6 py-3 bg-black text-white text-xs uppercase tracking-widest rounded mx-auto block">
                                            Browse Collections
                                        </button>
                                    </Link>
                                </div>
                                ...
                                <div className="space-y-8">
                                    {/* Table Header (Pseudo) */}
                                    <div className="hidden md:grid grid-cols-12 gap-6 text-[10px] text-gray-500 uppercase tracking-wider px-2 pb-4 border-b border-gray-100">
