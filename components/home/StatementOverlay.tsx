    ...
    return (
        <>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-full max-w-[90%] md:max-w-none flex justify-center pointer-events-none">
                <div className="bg-[#F5F3F0]/90 backdrop-blur-md px-10 py-6 rounded-2xl shadow-sm flex flex-wrap items-center justify-center gap-x-2 gap-y-3 text-[18px] md:text-[20px] leading-relaxed pointer-events-auto transition-all duration-300 hover:bg-[#F5F3F0]/95">
                    ...
                    <button
                        onClick={onFind}
                        className="ml-4 px-8 py-2.5 bg-black text-white text-sm uppercase tracking-widest rounded-full hover:bg-gray-800 transition-colors shadow-lg"
                    >
                        Find
                    </button>
                </div>
